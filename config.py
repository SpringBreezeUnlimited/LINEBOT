...
MAX_WEBHOOK_BODY_BYTES = parse_int_env(
    "MAX_WEBHOOK_BODY_BYTES", 1024 * 1024, 1024, MAX_REQUEST_BODY_BYTES
)
...
WEBHOOK_PENDING_JOB_LIMIT = parse_int_env(
    "WEBHOOK_PENDING_JOB_LIMIT", 1000, 1, 100000
)
WEBHOOK_JOB_LEASE_SECONDS = parse_int_env(
    "WEBHOOK_JOB_LEASE_SECONDS", 300, 30, 3600
)
WEBHOOK_JOB_RETRY_SECONDS = parse_int_env(
    "WEBHOOK_JOB_RETRY_SECONDS", 60, 1, 3600
)
